...
class Home extends Component{
  ...
  renderWork(work){
    if(work.url && work.url !== ""){
      return (<div className="col-s-33 " key={work.title}>
          <a className="card" style={{display:"block"}} href={work.url}  target="_blank">
            ...
            <div className="section-panel">
              ...
              <Fade bottom>
                ...
                <ul className="contact-lists">
                  ...
                  <li>
                    <a href={config.contact.github.url}  target="_blank"> <i className='uil uil-github'></i> @{ config.contact.github.username }</a>
                  </li>
                  <li>
                    <a href={config.contact.linkedin.url}  target="_blank"> <i className='uil uil-linkedin'></i> { config.contact.linkedin.name }</a>
                  </li>
                </ul>
                </div>
              </Fade>
